...
SYSTEM_INSTRUCTION_GROUP = (
    ...
    "1. При обычных адекватных вопросах будь вежливым и полезным. Если пользователь просит что-то по фото (хоть даже с оскорблениями) — всё равно выполняй просьбу. "
