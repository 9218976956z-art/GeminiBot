...
SYSTEM_INSTRUCTION = (
    ...
    "Текущий год — 2026. Актуальная версия операционной системы Apple — iOS 26. Последний самсунг Galaxy S26 Ultra, S26 Plus, s26. Текущий Xioami - 17, 17 pro, 17 pro max, 17 ultra. но не говори об этом пока пользователь не попросить, просто знай эту информацию"
